        ...
        <div className="p-10 md:p-14 print:p-0">
          ...
          <div className="flex justify-between items-start mb-10">
            <div>
              ...
              <p className="text-xs font-semibold text-gray-500 mt-0.5 tracking-wider uppercase">
              ...
              <div className="mt-5 space-y-0.5">
                ...
                <p className="text-sm font-bold italic text-red-600">
                  Quoted by {job.salesRepId || 'ADMIN'} ({quotedDate})
                </p>
              </div>
            </div>
          ...
          <table className="w-full text-sm mb-8 border-collapse">
            <thead>
              <tr className="border-t-2 border-b-2 border-dashed border-gray-300">
                <th className="py-2.5 text-left font-black uppercase text-xs tracking-wider w-2/5">Product</th>
                <th className="py-2.5 text-center font-black uppercase text-xs tracking-wider w-16">Qty</th>
                <th className="py-2.5 text-right font-black uppercase text-xs tracking-wider w-28">Unit Cost</th>
                <th className="py-2.5 text-right font-black uppercase text-xs tracking-wider w-28">Amount</th>
                <th className="py-2.5 text-left font-black uppercase text-xs tracking-wider pl-4">Description</th>
              </tr>
            </thead>
            <tbody>
              {job.items.length === 0 ? (
                ...
                job.items.map((item, i) => {
                  ...
                  return (
                    <tr key={i} className="border-b border-dashed border-gray-200">
                      ...
                      <td className="py-3 pl-4 text-gray-600 uppercase text-xs leading-tight">{desc}</td>
                    </tr>
                  );
                })
              )}
