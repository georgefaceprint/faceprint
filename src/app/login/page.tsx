...
const profiles: UserProfile[] = [
  { name: 'George', phone: '0820000001', color: 'from-blue-500 to-indigo-600', initial: 'G' },
  { name: 'Tanya', phone: '0820000002', color: 'from-purple-500 to-pink-600', initial: 'T' },
  { name: 'Cherine', phone: '0820000003', color: 'from-emerald-400 to-cyan-500', initial: 'C' },
];
          ...
          {!selectedUser ? (
            <div className="space-y-4">
              {profiles.map((profile) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg bg-gradient-to-br ${profile.color} shadow-lg group-hover:scale-105 transition-transform`}>
                    {profile.initial}
                  </div>
